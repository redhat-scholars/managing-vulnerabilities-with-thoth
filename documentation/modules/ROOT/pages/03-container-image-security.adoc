...
All these data can give you insights on the software that is available for use. Together with static analysis of container images as performed by Quay Clair <https://github.com/quay/clair[Quay Clair], Thoth guides also on the base container image security.
